import { DesktopLauncher, SectionLabel } from '../../components/ui/portfolio-os';
import { CanonicalSpec } from '../md-renderer';
import { mdPortfolioOsDesktopLauncher } from '../docs-map';

export function PortfolioOsDesktopLauncherDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdPortfolioOsDesktopLauncher} title="DesktopLauncher reference" />
    </div>
  );
}
