...
**Export path:** `@workspace/fes-os-design-system/components/ui/button`
**Preview page:** `button`
...
The general-purpose interactive button. Use for standard UI patterns — forms, dialogs, toolbars. For Fes OS portfolio actions (window controls, project links), prefer `ActionButton` from `fes-os.tsx`.
