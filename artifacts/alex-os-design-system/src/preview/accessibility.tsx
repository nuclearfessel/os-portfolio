import { SectionLabel, Surface, StatusIndicator } from '../components/ui/alex-os';
      ...
      <Surface elevation="floating" className="grid gap-6 p-6 lg:grid-cols-[1fr_auto] lg:items-end">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            Alex OS targets WCAG 2.2 Level AA. These rules describe the current portfolio implementation and the requirements every shared component must preserve.
          </p>
        </div>
