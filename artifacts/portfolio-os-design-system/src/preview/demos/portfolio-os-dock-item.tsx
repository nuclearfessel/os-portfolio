import { DockItem, DockItemLabel, SectionLabel } from '../../components/ui/portfolio-os';
import { CanonicalSpec } from '../md-renderer';
import { mdPortfolioOsDockItem } from '../docs-map';
...
export function PortfolioOsDockItemDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdPortfolioOsDockItem} title="DockItem / DockItemLabel reference" />
    </div>
  );
}
