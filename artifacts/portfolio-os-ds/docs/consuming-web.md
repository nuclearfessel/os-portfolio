...
```css
@import "@workspace/portfolio-os-ds/styles.css";
```
...
`node_modules/@workspace/portfolio-os-ds/src/components` to `content`.
...
import { cn } from "@workspace/portfolio-os-ds/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/portfolio-os-ds/hooks/use-toast";
```
...
`@workspace/portfolio-os-ds/components/ui/button`. Run the app's typecheck
