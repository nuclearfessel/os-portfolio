# Fes OS Design System — Documentation

Welcome to the documentation root for `@workspace/fes-os-design-system`. Every spec, foundation, pattern, and reference lives here.
...
| [Iconography & Motion](./foundations/iconography-motion.md) | `fes-os-guidelines` |
...
Source: `src/components/ui/fes-os.tsx` · Preview: `fes-os-pilot`

| Component | Spec |
|---|---|
| ActionButton | [→](./components/fes-os/action-button.md) |
| SectionLabel | [→](./components/fes-os/section-label.md) |
| StatusIndicator | [→](./components/fes-os/status-indicator.md) |
| Surface | [→](./components/fes-os/surface.md) |
| ProjectCard | [→](./components/fes-os/project-card.md) |
| WindowSurface | [→](./components/fes-os/window-surface.md) |
| DockItem / DockItemLabel | [→](./components/fes-os/dock-item.md) |
| DesktopLauncher | [→](./components/fes-os/desktop-launcher.md) |
| StickyNoteSurface | [→](./components/fes-os/sticky-note-surface.md) |
| ContextMenuSurface | [→](./components/fes-os/context-menu-surface.md) |

### Settings primitives

Source: `src/components/ui/settings.tsx` · Preview: `fes-os-settings`
