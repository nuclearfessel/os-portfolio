# Consuming Portfolio OS Design System in Expo apps

Read `artifacts/portfolio-os-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/portfolio-os-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { nativeTheme } from "@workspace/portfolio-os-design-system/lib/native-theme";
import { useColors } from "@workspace/portfolio-os-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/portfolio-os-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/portfolio-os-design-system/components/native/badge";
import { Button } from "@workspace/portfolio-os-design-system/components/native/button";
import { Card } from "@workspace/portfolio-os-design-system/components/native/card";
```
...
Import and render
`@workspace/portfolio-os-design-system/components/native/button`, then run Expo
