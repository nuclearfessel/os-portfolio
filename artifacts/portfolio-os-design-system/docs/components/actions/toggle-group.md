...
**Export path:** `@workspace/portfolio-os-design-system/components/ui/toggle-group`
...
```tsx
import { ToggleGroup, ToggleGroupItem } from '@workspace/portfolio-os-design-system/components/ui/toggle-group';
