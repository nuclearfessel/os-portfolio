...
**Preview:** `portfolio-os-pilot` (ProjectCard demo), `item` (Item family)
...
|---|---|---|
| `ProjectCard` | `portfolio-os.tsx` | Primary project row |
| `ActionButton` | `portfolio-os.tsx` | "View case study" action |
...
```tsx
import { ProjectCard, ActionButton, SectionLabel } from '@workspace/portfolio-os-design-system/components/ui/portfolio-os';
