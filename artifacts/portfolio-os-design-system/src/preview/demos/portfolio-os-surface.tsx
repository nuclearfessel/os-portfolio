import { Surface, SectionLabel } from '../../components/ui/portfolio-os';
import { CanonicalSpec } from '../md-renderer';
import { mdPortfolioOsSurface } from '../docs-map';

export function PortfolioOsSurfaceDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdPortfolioOsSurface} title="Surface reference" />
    </div>
  );
}
