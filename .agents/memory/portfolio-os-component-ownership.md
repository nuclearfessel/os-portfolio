---
name: Portfolio OS component ownership
description: Approved boundary between shared visual components and portfolio-specific desktop behavior.
---

Shared visual primitives and structural surfaces belong to the Portfolio OS Design System package and should be consumed directly by the portfolio. Product-specific behavior—dragging, resizing, persistence, keyboard control, window focus, and responsive workspace state—stays in the portfolio.
...
Keep the 18 Portfolio OS and Settings primitive details accessible through one compact “Portfolio OS primitives” directory entry under Patterns; do not flatten detail links into the sidebar. Detail pages must link back to the directory.