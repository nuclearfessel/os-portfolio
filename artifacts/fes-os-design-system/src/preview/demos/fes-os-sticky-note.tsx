import { StickyNoteSurface, SectionLabel } from '../../components/ui/fes-os';
import { CanonicalSpec } from '../md-renderer';
import { mdFesOsStickyNote } from '../docs-map';

export function FesOsStickyNoteDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdFesOsStickyNote} title="StickyNoteSurface reference" />
    </div>
  );
}
