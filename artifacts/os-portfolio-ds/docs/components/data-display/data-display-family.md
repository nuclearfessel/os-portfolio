...
```tsx
import { Avatar, AvatarImage, AvatarFallback } from '@workspace/os-portfolio-ds/components/ui/avatar';
...
```tsx
import { Badge } from '@workspace/os-portfolio-ds/components/ui/badge';
...
```tsx
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter } from '@workspace/os-portfolio-ds/components/ui/card';
...
```tsx
import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell } from '@workspace/os-portfolio-ds/components/ui/table';
...
```tsx
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '@workspace/os-portfolio-ds/components/ui/accordion';
...
```tsx
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from '@workspace/os-portfolio-ds/components/ui/collapsible';
...
```tsx
import { Carousel, CarouselContent, CarouselItem, CarouselPrevious, CarouselNext } from '@workspace/os-portfolio-ds/components/ui/carousel';
...
```tsx
import { Item, ItemGroup, ItemMedia, ItemContent, ItemTitle, ItemDescription, ItemActions } from '@workspace/os-portfolio-ds/components/ui/item';
...
```tsx
import { Empty } from '@workspace/os-portfolio-ds/components/ui/empty';
...
```tsx
import { Kbd, KbdGroup } from '@workspace/os-portfolio-ds/components/ui/kbd';
...
```tsx
import { AspectRatio } from '@workspace/os-portfolio-ds/components/ui/aspect-ratio';
