# Consuming Portfolio OS Design System in web apps

Read `artifacts/portfolio-os-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/portfolio-os-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/portfolio-os-design-system/styles.css";
```
...
`node_modules/@workspace/portfolio-os-design-system/src/components` to `content`.
...
import { cn } from "@workspace/portfolio-os-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/portfolio-os-design-system/hooks/use-toast";
```
...
`@workspace/portfolio-os-design-system/components/ui/button`. Run the app's typecheck
