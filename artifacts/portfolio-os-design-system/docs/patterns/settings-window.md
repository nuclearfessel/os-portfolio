...
|---|---|---|
| `WindowSurface` | `portfolio-os.tsx` | Window shell |
...
This is the reference implementation of the universal Portfolio OS side-navigation window contract. Apply the same transformation to every resizable window that has side navigation; it is not specific to Settings.
...
```tsx
import { WindowSurface, SectionLabel } from '@workspace/portfolio-os-design-system/components/ui/portfolio-os';
import {
  SettingsNavSection, SettingsNavItem,
  SettingsSectionHeader, SettingsDivider,
  SettingsToggleRow, SettingsSliderGroup,
} from '@workspace/portfolio-os-design-system/components/ui/settings';
