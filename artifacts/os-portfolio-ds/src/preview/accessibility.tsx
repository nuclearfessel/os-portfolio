...
import { SectionLabel, Surface, StatusIndicator } from '../components/ui/os-portfolio';
import {
    ...
    <div className="space-y-6">
      ...
      <Surface elevation="flat" className="grid gap-6 p-6 lg:grid-cols-[1fr_auto] lg:items-end">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            OS Portfolio targets WCAG 2.2 Level AA. These rules describe the current portfolio implementation and
      ...
      <section className="overflow-hidden rounded-xl border bg-card text-card-foreground">
        <div className="border-b p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            ...
            <code className="font-mono">.portfolio-surface-translucent</code> is the only component-level hook —
        ...
        <div className="divide-y">
          ...
          {/* portfolio-surface-translucent + no-transparency */}
          <article className="grid gap-4 p-6 lg:grid-cols-[14rem_1fr]">
            <div>
              <div className="flex flex-col gap-1">
                <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[0.625rem] text-primary">.portfolio-surface-translucent</code>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <Surface className="p-5">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-muted-foreground">
            <li>Add <code className="font-mono">.portfolio-surface-translucent</code> to surfaces that should carry adjustable transparency (windows, dock panels, floating menus).</li>
            <li>When <code className="font-mono">data-no-transparency</code> is on the shell, <code className="font-mono">.portfolio-surface-translucent</code> surfaces become fully opaque — <code className="font-mono">backdrop-filter</code> removed, background alpha removed.</li>
            <li><strong>Both contrast modes force <code className="font-mono">.portfolio-surface-translucent</code> opaque directly</strong> — the package stylesheet includes <code className="font-mono">[data-contrast="low"] .portfolio-surface-translucent</code> and <code className="font-mono">[data-contrast="high"] .portfolio-surface-translucent</code> rules that disable blur and alpha. The consuming app does <em>not</em> need to also set <code className="font-mono">data-no-transparency</code>. Other surfaces (using plain <code className="font-mono">bg-card</code> or inline backgrounds) are <em>not</em> automatically made opaque by the contrast rules alone — only <code className="font-mono">.portfolio-surface-translucent</code> is covered.</li>
        ...
        <Surface className="p-5">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-muted-foreground">
            ...
            <li><code className="font-mono">.portfolio-surface-translucent</code> surfaces are forced opaque so contrast-palette backgrounds are not diluted by backdrop-filter alpha.</li>
          </ul>
        </Surface>
        <Surface className="p-5">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-muted-foreground">
            ...
            <li><code className="font-mono">.portfolio-surface-translucent</code> surfaces are forced opaque directly by the package stylesheet. This covers the opacity/blur of translucent surfaces only — the package does not and cannot guarantee that every inline <code className="font-mono">rgba()</code> or <code className="font-mono">bg-*/*</code> background set by the consuming app is also made opaque. The consuming app should avoid alpha backgrounds under contrast modes.</li>
          </ul>
        </Surface>
      </section>
