...
**Preview:** `portfolio-os-pilot` (DesktopLauncher demo)
...
|---|---|---|
| `DesktopLauncher` | `portfolio-os.tsx` | Activatable launcher button (`is-open` class) |
| `SectionLabel` | `portfolio-os.tsx` | Optional launcher label below the icon |
...
```tsx
import { DesktopLauncher, SectionLabel } from '@workspace/portfolio-os-design-system/components/ui/portfolio-os';
