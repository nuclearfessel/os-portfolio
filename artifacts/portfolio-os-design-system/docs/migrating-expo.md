# Migrating Expo UI to Portfolio OS Design System

Read `artifacts/portfolio-os-design-system/docs/AGENTS.md` and
`artifacts/portfolio-os-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/portfolio-os-design-system/lib/native-theme` and
  `@workspace/portfolio-os-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/portfolio-os-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/portfolio-os-design-system` and retains only
