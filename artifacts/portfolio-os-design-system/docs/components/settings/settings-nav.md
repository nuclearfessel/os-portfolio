...
Settings is the reference implementation. Every Portfolio OS resizable window with side navigation must follow this same container-responsive transformation.
