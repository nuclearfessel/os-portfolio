...
Add `fes-surface-translucent` alongside your `bg-card` override if the window should respond to the user's transparency preference:
...
```tsx
import { WindowSurface } from '@workspace/fes-os-design-system/components/ui/fes-os';
