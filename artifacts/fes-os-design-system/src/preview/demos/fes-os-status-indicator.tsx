import { StatusIndicator } from '../../components/ui/fes-os';
import { CanonicalSpec } from '../md-renderer';
import { mdFesOsStatusIndicator } from '../docs-map';

export function FesOsStatusIndicatorDemo() {
  return (
    <div className="space-y-8">
      <div className="space-y-6 rounded-lg border border-border bg-card p-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 rounded-md border border-border bg-muted/40 px-4 py-2">
            <span className="font-mono text-xs text-muted-foreground">~/fes</span>
      ...
      <CanonicalSpec md={mdFesOsStatusIndicator} title="StatusIndicator reference" />
    </div>
  );
}
