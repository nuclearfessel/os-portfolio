...
```tsx
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator } from '@workspace/portfolio-os-ds/components/ui/dropdown-menu';
...
```tsx
import { ContextMenu, ContextMenuTrigger, ContextMenuContent, ContextMenuItem } from '@workspace/portfolio-os-ds/components/ui/context-menu';
...
```tsx
import { Menubar, MenubarMenu, MenubarTrigger, MenubarContent, MenubarItem } from '@workspace/portfolio-os-ds/components/ui/menubar';
...
```tsx
import { NavigationMenu, NavigationMenuList, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuContent } from '@workspace/portfolio-os-ds/components/ui/navigation-menu';
...
```tsx
import { Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbLink, BreadcrumbPage, BreadcrumbSeparator } from '@workspace/portfolio-os-ds/components/ui/breadcrumb';
...
```tsx
import { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationPrevious, PaginationNext } from '@workspace/portfolio-os-ds/components/ui/pagination';
...
```tsx
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@workspace/portfolio-os-ds/components/ui/tabs';
...
```tsx
import { SidebarProvider, Sidebar, SidebarContent, SidebarGroup, SidebarGroupLabel, SidebarGroupContent, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarInset, SidebarTrigger } from '@workspace/portfolio-os-ds/components/ui/sidebar';
