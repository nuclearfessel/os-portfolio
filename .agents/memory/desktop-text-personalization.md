...
**How to apply:** Persist shared copy and per-theme colors. Edit the active theme's color through the shared color picker in a named floating modal dialog with a transparent overlay, without changing the other theme. Warning dialogs retain their scrims.