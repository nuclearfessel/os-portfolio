...
## Portfolio OS primitives

Source: `src/components/ui/portfolio-os.tsx`
Preview ID: `portfolio-os-pilot`

| Component | Export | Spec | Preview ID |
|---|---|---|---|
| ActionButton | `ActionButton` | [action-button.md](../components/portfolio-os/action-button.md) | `portfolio-os-pilot` |
| SectionLabel | `SectionLabel` | [section-label.md](../components/portfolio-os/section-label.md) | `portfolio-os-pilot` |
| StatusIndicator | `StatusIndicator` | [status-indicator.md](../components/portfolio-os/status-indicator.md) | `portfolio-os-pilot` |
| Surface | `Surface` | [surface.md](../components/portfolio-os/surface.md) | `portfolio-os-pilot` |
| ProjectCard | `ProjectCard` | [project-card.md](../components/portfolio-os/project-card.md) | `portfolio-os-pilot` |
| WindowSurface | `WindowSurface` | [window-surface.md](../components/portfolio-os/window-surface.md) | `portfolio-os-pilot` |
| DockItem | `DockItem` | [dock-item.md](../components/portfolio-os/dock-item.md) | `portfolio-os-pilot` |
| DockItemLabel | `DockItemLabel` | [dock-item.md](../components/portfolio-os/dock-item.md) | `portfolio-os-pilot` |
| DesktopLauncher | `DesktopLauncher` | [desktop-launcher.md](../components/portfolio-os/desktop-launcher.md) | `portfolio-os-pilot` |
| StickyNoteSurface | `StickyNoteSurface` | [sticky-note-surface.md](../components/portfolio-os/sticky-note-surface.md) | `portfolio-os-pilot` |
| ContextMenuSurface | `ContextMenuSurface` | [context-menu-surface.md](../components/portfolio-os/context-menu-surface.md) | `portfolio-os-pilot` |
...
Preview ID: `portfolio-os-settings`

| Component | Export | Spec | Preview ID |
|---|---|---|---|
| SettingsNavSection | `SettingsNavSection` | [settings-nav.md](../components/settings/settings-nav.md) | `portfolio-os-settings` |
| SettingsNavItem | `SettingsNavItem` | [settings-nav.md](../components/settings/settings-nav.md) | `portfolio-os-settings` |
| SettingsToggleRow | `SettingsToggleRow` | [settings-toggle-row.md](../components/settings/settings-toggle-row.md) | `portfolio-os-settings` |
| SettingsSliderGroup | `SettingsSliderGroup` | [settings-slider-group.md](../components/settings/settings-slider-group.md) | `portfolio-os-settings` |
| SettingsSegmentedChoice | `SettingsSegmentedChoice` | [settings-segmented-choice.md](../components/settings/settings-segmented-choice.md) | `portfolio-os-settings` |
| SettingsContrastCard | `SettingsContrastCard` | [settings-contrast-card.md](../components/settings/settings-contrast-card.md) | `portfolio-os-settings` |
| SettingsColorPreset | `SettingsColorPreset` | [settings-color-preset.md](../components/settings/settings-color-preset.md) | `portfolio-os-settings` |
| SettingsDivider | `SettingsDivider` | [settings-divider.md](../components/settings/settings-divider.md) | `portfolio-os-settings` |
| SettingsSectionHeader | `SettingsSectionHeader` | [settings-section-header.md](../components/settings/settings-section-header.md) | `portfolio-os-settings` |
...
| Iconography & Motion | [foundations/iconography-motion.md](../foundations/iconography-motion.md) | `portfolio-os-guidelines` |
...
|---|---|---|
| Desktop window workspace | [desktop-window-workspace.md](../patterns/desktop-window-workspace.md) | `portfolio-os-pilot` |
| Responsive Dock navigation | [responsive-dock.md](../patterns/responsive-dock.md) | `portfolio-os-pilot` |
| Desktop launcher grid | [desktop-launcher-grid.md](../patterns/desktop-launcher-grid.md) | `portfolio-os-pilot` |
| Sticky notes | [sticky-notes.md](../patterns/sticky-notes.md) | `portfolio-os-pilot` |
| Context menus | [context-menus.md](../patterns/context-menus.md) | `portfolio-os-pilot`, `context-menu` |
| Project-card list | [project-card-list.md](../patterns/project-card-list.md) | `portfolio-os-pilot`, `item` |
| Settings window & sidebar | [settings-window.md](../patterns/settings-window.md) | `portfolio-os-settings` |
| Personalization color presets | [personalization-colors.md](../patterns/personalization-colors.md) | `portfolio-os-settings` |
| Accessibility preference panel | [accessibility-panel.md](../patterns/accessibility-panel.md) | `portfolio-os-settings`, `accessibility` |
| Contrast override behavior | [contrast-override.md](../patterns/contrast-override.md) | `portfolio-os-settings` |
| Transparency surfaces | [transparency-surfaces.md](../patterns/transparency-surfaces.md) | `portfolio-os-settings` |
