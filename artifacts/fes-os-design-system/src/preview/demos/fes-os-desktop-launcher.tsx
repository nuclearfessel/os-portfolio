import { DesktopLauncher, SectionLabel } from '../../components/ui/fes-os';
import { CanonicalSpec } from '../md-renderer';
import { mdFesOsDesktopLauncher } from '../docs-map';

export function FesOsDesktopLauncherDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdFesOsDesktopLauncher} title="DesktopLauncher reference" />
    </div>
  );
}
