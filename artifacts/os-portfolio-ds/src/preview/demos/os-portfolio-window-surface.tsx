import { WindowSurface, SectionLabel } from '../../components/ui/os-portfolio';
import { CanonicalSpec } from '../md-renderer';
import { mdOsPortfolioWindowSurface } from '../docs-map';

export function OsPortfolioWindowSurfaceDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdOsPortfolioWindowSurface} title="WindowSurface reference" />
    </div>
  );
}
