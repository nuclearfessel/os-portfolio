...
Responsive tablet and mobile layout is temporary presentation state. Preserve the last desktop window, sticky, launcher, Dock, and system-bar geometry while another workspace mode is active, then restore it when desktop mode returns.
