# Portfolio OS Design System — Documentation

Welcome to the documentation root for `@workspace/portfolio-os-design-system`. Every spec, foundation, pattern, and reference lives here.
...
| [Iconography & Motion](./foundations/iconography-motion.md) | `portfolio-os-guidelines` |
...
Source: `src/components/ui/portfolio-os.tsx` · Preview: `portfolio-os-pilot`

| Component | Spec |
|---|---|
| ActionButton | [→](./components/portfolio-os/action-button.md) |
| SectionLabel | [→](./components/portfolio-os/section-label.md) |
| StatusIndicator | [→](./components/portfolio-os/status-indicator.md) |
| Surface | [→](./components/portfolio-os/surface.md) |
| ProjectCard | [→](./components/portfolio-os/project-card.md) |
| WindowSurface | [→](./components/portfolio-os/window-surface.md) |
| DockItem / DockItemLabel | [→](./components/portfolio-os/dock-item.md) |
| DesktopLauncher | [→](./components/portfolio-os/desktop-launcher.md) |
| StickyNoteSurface | [→](./components/portfolio-os/sticky-note-surface.md) |
| ContextMenuSurface | [→](./components/portfolio-os/context-menu-surface.md) |

### Settings primitives

Source: `src/components/ui/settings.tsx` · Preview: `portfolio-os-settings`
