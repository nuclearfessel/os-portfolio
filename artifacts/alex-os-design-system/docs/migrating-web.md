# Migrating web UI to Alex OS Design System

Read `artifacts/alex-os-design-system/docs/AGENTS.md` and
`artifacts/alex-os-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/alex-os-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/alex-os-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/alex-os-design-system/hooks/use-toast`
