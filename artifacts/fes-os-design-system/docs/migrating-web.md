# Migrating web UI to Fes OS Design System

Read `artifacts/fes-os-design-system/docs/AGENTS.md` and
`artifacts/fes-os-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/fes-os-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/fes-os-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/fes-os-design-system/hooks/use-toast`
