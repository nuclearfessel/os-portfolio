...
```tsx
import { Dialog, DialogTrigger, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter, DialogClose } from '@workspace/os-portfolio-ds/components/ui/dialog';
...
```tsx
import { AlertDialog, AlertDialogTrigger, AlertDialogContent, AlertDialogHeader, AlertDialogTitle, AlertDialogDescription, AlertDialogFooter, AlertDialogCancel, AlertDialogAction } from '@workspace/os-portfolio-ds/components/ui/alert-dialog';
...
```tsx
import { Sheet, SheetTrigger, SheetContent, SheetHeader, SheetTitle } from '@workspace/os-portfolio-ds/components/ui/sheet';
...
```tsx
import { Drawer, DrawerTrigger, DrawerContent, DrawerHeader, DrawerTitle } from '@workspace/os-portfolio-ds/components/ui/drawer';
...
```tsx
import { Popover, PopoverTrigger, PopoverContent } from '@workspace/os-portfolio-ds/components/ui/popover';
...
```tsx
import { HoverCard, HoverCardTrigger, HoverCardContent } from '@workspace/os-portfolio-ds/components/ui/hover-card';
...
```tsx
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from '@workspace/os-portfolio-ds/components/ui/tooltip';
...
```tsx
import { Command, CommandInput, CommandList, CommandGroup, CommandItem, CommandEmpty } from '@workspace/os-portfolio-ds/components/ui/command';
