import { ActionButton } from '../../components/ui/fes-os';
import { CanonicalSpec } from '../md-renderer';
import { mdFesOsActionButton } from '../docs-map';

export function FesOsActionButtonDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdFesOsActionButton} title="ActionButton reference" />
    </div>
  );
}
