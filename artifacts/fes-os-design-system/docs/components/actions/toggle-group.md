...
**Export path:** `@workspace/fes-os-design-system/components/ui/toggle-group`
...
```tsx
import { ToggleGroup, ToggleGroupItem } from '@workspace/fes-os-design-system/components/ui/toggle-group';
