...
|---|---|---|
| `DockItem` | `os-portfolio.tsx` | Activatable button cell |
| `DockItemLabel` | `os-portfolio.tsx` | Breakpoint-switched label |
...
```tsx
import { DockItem, DockItemLabel } from '@workspace/portfolio-os-ds/components/ui/os-portfolio';
