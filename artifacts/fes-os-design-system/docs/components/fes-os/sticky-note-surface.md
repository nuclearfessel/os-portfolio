...
```tsx
import { StickyNoteSurface } from '@workspace/fes-os-design-system/components/ui/fes-os';
import { SectionLabel } from '@workspace/fes-os-design-system/components/ui/fes-os';
