...
workspace package (`@workspace/portfolio-os-ds`): other artifacts depend
...
`@workspace/portfolio-os-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/portfolio-os-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/portfolio-os-ds` as a `workspace:*` dependency,
