# Consuming Alex OS Design System in web apps

Read `artifacts/alex-os-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/alex-os-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/alex-os-design-system/styles.css";
```
...
`node_modules/@workspace/alex-os-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/alex-os-design-system/components/ui/button";
import { cn } from "@workspace/alex-os-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/alex-os-design-system/hooks/use-toast";
```
...
`@workspace/alex-os-design-system/components/ui/button`. Run the app's typecheck
