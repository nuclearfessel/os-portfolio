# Migrating Expo UI to Alex OS Design System

Read `artifacts/alex-os-design-system/docs/AGENTS.md` and
`artifacts/alex-os-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/alex-os-design-system/lib/native-theme` and
  `@workspace/alex-os-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/alex-os-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/alex-os-design-system` and retains only
