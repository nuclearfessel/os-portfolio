...
|---|---|---|
| `DesktopLauncher` | `os-portfolio.tsx` | Activatable launcher button (`is-open` class) |
| `SectionLabel` | `os-portfolio.tsx` | Optional launcher label below the icon |
...
```tsx
import { DesktopLauncher, SectionLabel } from '@workspace/portfolio-os-ds/components/ui/os-portfolio';
