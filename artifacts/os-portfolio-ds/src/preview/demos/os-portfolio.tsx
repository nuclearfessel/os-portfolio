...
import {
  mdOsPortfolioActionButton,
  mdOsPortfolioSectionLabel,
  mdOsPortfolioStatusIndicator,
  mdOsPortfolioSurface,
  mdOsPortfolioProjectCard,
  mdOsPortfolioWindowSurface,
  mdOsPortfolioDockItem,
  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <h1 className="text-3xl font-semibold tracking-tight">OS Portfolio primitives</h1>
