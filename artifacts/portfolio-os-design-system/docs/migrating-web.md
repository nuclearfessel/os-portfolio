# Migrating web UI to Portfolio OS Design System

Read `artifacts/portfolio-os-design-system/docs/AGENTS.md` and
`artifacts/portfolio-os-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/portfolio-os-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/portfolio-os-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/portfolio-os-design-system/hooks/use-toast`
