...
```css
@import "@workspace/os-portfolio-ds/styles.css";
```
...
`node_modules/@workspace/os-portfolio-ds/src/components` to `content`.
...
import { cn } from "@workspace/os-portfolio-ds/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/os-portfolio-ds/hooks/use-toast";
```
...
`@workspace/os-portfolio-ds/components/ui/button`. Run the app's typecheck
