...
```tsx
import { StickyNoteSurface } from '@workspace/portfolio-os-design-system/components/ui/portfolio-os';
import { SectionLabel } from '@workspace/portfolio-os-design-system/components/ui/portfolio-os';
