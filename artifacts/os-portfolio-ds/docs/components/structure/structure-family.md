...
```tsx
import { ScrollArea } from '@workspace/os-portfolio-ds/components/ui/scroll-area';
...
```tsx
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from '@workspace/os-portfolio-ds/components/ui/resizable';
...
- Note: ResizablePanelGroup is for bounded in-page split panes. The OS Portfolio desktop window resize (free-form, user-arranged) is a consuming-product responsibility — not provided by this component.
