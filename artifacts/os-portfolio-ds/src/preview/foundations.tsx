...
const TAXONOMY_LEVELS = [
  { level: 'Namespace', value: 'osp', note: 'Generated CSS only' },
...
// Components: 11 Desktop primitives + 8 Settings primitives + 14 generic + 2 family overviews = 35
// The os-portfolio-primitives directory is the single sidebar entry for all 19 primitives.
const PUBLIC_COUNTS = {
  foundations: 7,
  components: 35,
  patterns: 12,
    ...
    <div className="space-y-4">
      ...
      <section className="rounded-xl border bg-card p-5 text-card-foreground">
        ...
        <h2 className="mt-2 text-lg font-semibold tracking-tight">
          Live documentation for the OS Portfolio desktop portfolio
        </h2>
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-5 rounded-xl border bg-card p-6 text-card-foreground">
        ...
        <p className="font-mono text-[0.6875rem] text-muted-foreground">
          Proposed generated CSS namespace: --osp-. Mode stays last; scale is
