# Consuming Fes OS Design System in Expo apps

Read `artifacts/fes-os-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/fes-os-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/fes-os-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/fes-os-design-system/lib/native-theme";
import { useColors } from "@workspace/fes-os-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/fes-os-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/fes-os-design-system/components/native/badge";
import { Button } from "@workspace/fes-os-design-system/components/native/button";
import { Card } from "@workspace/fes-os-design-system/components/native/card";
```
...
Import and render
`@workspace/fes-os-design-system/components/native/button`, then run Expo
