# Consuming Alex OS Design System in Expo apps

Read `artifacts/alex-os-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/alex-os-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/alex-os-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/alex-os-design-system/lib/native-theme";
import { useColors } from "@workspace/alex-os-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/alex-os-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/alex-os-design-system/components/native/badge";
import { Button } from "@workspace/alex-os-design-system/components/native/button";
import { Card } from "@workspace/alex-os-design-system/components/native/card";
```
...
Import and render
`@workspace/alex-os-design-system/components/native/button`, then run Expo
