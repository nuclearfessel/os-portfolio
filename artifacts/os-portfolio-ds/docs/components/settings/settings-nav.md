...
Settings is the reference implementation. Every OS Portfolio resizable window with side navigation must follow this same container-responsive transformation.
