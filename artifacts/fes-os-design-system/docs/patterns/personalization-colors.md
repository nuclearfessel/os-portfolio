...
**Preview:** `fes-os-settings` (Personalization section)
...
```tsx
import { SettingsColorPreset, SettingsSectionHeader } from '@workspace/fes-os-design-system/components/ui/settings';
