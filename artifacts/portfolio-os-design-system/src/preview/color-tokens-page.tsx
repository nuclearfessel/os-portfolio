/**
 * Color Tokens page — EightShapes taxonomy preview with os namespace.
 *
 ...
 * have not been renamed. Generated spacing/radius CSS already uses --os-; color
...
// Namespace: os
//
// Primitive:  os.color.palette.<name>
// Semantic:   os.color.<property>[.<concept>].<mode>
// Component:  os.<component>.<element>.color.<property>[.<variant|state>].<mode>
//
...
// Primitive: os.color.palette.<family>.<scale>
function primTokenName(key: string): string {
  return `os.color.palette.${PRIMITIVE_PROPOSED[key] ?? key}`;
}
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          <p className="text-sm font-medium">
            ...
            <code className="rounded bg-muted px-1 font-mono text-xs">os</code> namespace
          </p>
          <p className="mt-1 text-sm leading-6 text-muted-foreground">
            ...
            <code className="font-mono text-xs">--os-</code> CSS namespace.
          ...
          <div key={compKey} className="overflow-hidden rounded-lg border">
            <div className="flex items-center gap-2.5 border-b bg-muted/30 px-3 py-2">
              <code className="font-mono text-xs font-medium text-foreground">
                os.{meta.display}.{meta.element}.color.*
              </code>
  ...
  return (
    <section className="space-y-5 rounded-xl border bg-card p-6 text-card-foreground">
      ...
      <p className="font-mono text-[0.6875rem] text-muted-foreground">
        ...
        Proposed namespace: <code className="rounded bg-muted px-1">os</code>.
...
const TAXONOMY_ROWS = [
  { segment: 'Namespace', value: 'os', note: 'Proposed; color CSS not yet renamed (spacing/radius already use os)' },
    ...
    <section className="space-y-4 rounded-xl border bg-card p-6 text-card-foreground">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {[
          {
            layer: 'Primitive',
            pattern: 'os.color.palette.<name>',
            example: 'os.color.palette.teal',
          },
          {
            layer: 'Semantic',
            pattern: 'os.color.<property>[.<concept>].<mode>',
            example: 'os.color.background.action.primary.light',
          },
          {
            layer: 'Component',
            pattern: 'os.<component>.<element>.color.<property>[.<variant>].<mode>',
            example: 'os.action-button.container.color.background.light',
          },
        ].map((t) => (
