...
**Preview:** `portfolio-os-pilot` (StickyNoteSurface demo)
...
|---|---|---|
| `StickyNoteSurface` | `portfolio-os.tsx` | Surface shell (border, shadow, rounded) |
| `SectionLabel` | `portfolio-os.tsx` | Optional note type / number kicker |
| `ActionButton` | `portfolio-os.tsx` | Optional delete/action control |
...
```tsx
import { StickyNoteSurface, SectionLabel, ActionButton } from '@workspace/portfolio-os-design-system/components/ui/portfolio-os';
