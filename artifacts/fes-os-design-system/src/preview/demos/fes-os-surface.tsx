import { Surface, SectionLabel } from '../../components/ui/fes-os';
import { CanonicalSpec } from '../md-renderer';
import { mdFesOsSurface } from '../docs-map';

export function FesOsSurfaceDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdFesOsSurface} title="Surface reference" />
    </div>
  );
}
