import { ContextMenuSurface, SectionLabel } from '../../components/ui/portfolio-os';
import { CanonicalSpec } from '../md-renderer';
import { mdPortfolioOsContextMenuSurface } from '../docs-map';

export function PortfolioOsContextMenuSurfaceDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdPortfolioOsContextMenuSurface} title="ContextMenuSurface reference" />
    </div>
  );
}
