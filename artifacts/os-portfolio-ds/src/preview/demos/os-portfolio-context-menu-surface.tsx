import { ContextMenuSurface, SectionLabel } from '../../components/ui/os-portfolio';
import { CanonicalSpec } from '../md-renderer';
import { mdOsPortfolioContextMenuSurface } from '../docs-map';

export function OsPortfolioContextMenuSurfaceDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdOsPortfolioContextMenuSurface} title="ContextMenuSurface reference" />
    </div>
  );
}
