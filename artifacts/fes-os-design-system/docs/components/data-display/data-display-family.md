...
```tsx
import { Avatar, AvatarImage, AvatarFallback } from '@workspace/fes-os-design-system/components/ui/avatar';

<Avatar>
  <AvatarImage src="/avatar.jpg" alt="Fes Naqvi" />
...
```tsx
import { Badge } from '@workspace/fes-os-design-system/components/ui/badge';
...
```tsx
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter } from '@workspace/fes-os-design-system/components/ui/card';
...
```tsx
import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell } from '@workspace/fes-os-design-system/components/ui/table';
...
```tsx
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '@workspace/fes-os-design-system/components/ui/accordion';

<Accordion type="single" collapsible>
  <AccordionItem value="item-1">
    <AccordionTrigger>What is Fes OS?</AccordionTrigger>
...
```tsx
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from '@workspace/fes-os-design-system/components/ui/collapsible';
...
```tsx
import { Carousel, CarouselContent, CarouselItem, CarouselPrevious, CarouselNext } from '@workspace/fes-os-design-system/components/ui/carousel';
...
```tsx
import { Item, ItemGroup, ItemMedia, ItemContent, ItemTitle, ItemDescription, ItemActions } from '@workspace/fes-os-design-system/components/ui/item';

<ItemGroup>
  <Item variant="outline">
    <ItemMedia variant="icon"><FolderIcon /></ItemMedia>
    <ItemContent>
      <ItemTitle>Orbit CRM</ItemTitle>
      <ItemDescription>A calmer command center for customer teams.</ItemDescription>
    </ItemContent>
    <ItemActions>
...
```tsx
import { Empty } from '@workspace/fes-os-design-system/components/ui/empty';
...
```tsx
import { Kbd, KbdGroup } from '@workspace/fes-os-design-system/components/ui/kbd';
...
```tsx
import { AspectRatio } from '@workspace/fes-os-design-system/components/ui/aspect-ratio';
