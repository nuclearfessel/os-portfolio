# Consuming Fes OS Design System in web apps

Read `artifacts/fes-os-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/fes-os-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/fes-os-design-system/styles.css";
```
...
`node_modules/@workspace/fes-os-design-system/src/components` to `content`.
...
import { cn } from "@workspace/fes-os-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/fes-os-design-system/hooks/use-toast";
```
...
`@workspace/fes-os-design-system/components/ui/button`. Run the app's typecheck
