# Migrating Expo UI to Fes OS Design System

Read `artifacts/fes-os-design-system/docs/AGENTS.md` and
`artifacts/fes-os-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/fes-os-design-system/lib/native-theme` and
  `@workspace/fes-os-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/fes-os-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/fes-os-design-system` and retains only
