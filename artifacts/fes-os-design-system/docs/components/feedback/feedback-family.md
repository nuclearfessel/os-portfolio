...
```tsx
import { Alert, AlertTitle, AlertDescription } from '@workspace/fes-os-design-system/components/ui/alert';
...
```tsx
import { Progress } from '@workspace/fes-os-design-system/components/ui/progress';
...
```tsx
import { Skeleton } from '@workspace/fes-os-design-system/components/ui/skeleton';
...
```tsx
import { Spinner } from '@workspace/fes-os-design-system/components/ui/spinner';
...
// In any component:
import { useToast } from '@workspace/fes-os-design-system/hooks/use-toast';
...
```tsx
// In app root:
import { Toaster } from '@workspace/fes-os-design-system/components/ui/sonner';
<Toaster richColors />
