...
import { mdPortfolioOsSectionLabel } from '../docs-map';

export function PortfolioOsSectionLabelDemo() {
  return (
    <div className="space-y-8">
      ...
      <CanonicalSpec md={mdPortfolioOsSectionLabel} title="SectionLabel reference" />
    </div>
  );
}
