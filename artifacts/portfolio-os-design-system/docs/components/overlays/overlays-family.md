...
```tsx
import { Dialog, DialogTrigger, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter, DialogClose } from '@workspace/portfolio-os-design-system/components/ui/dialog';
import { Button } from '@workspace/portfolio-os-design-system/components/ui/button';
...
```tsx
import { AlertDialog, AlertDialogTrigger, AlertDialogContent, AlertDialogHeader, AlertDialogTitle, AlertDialogDescription, AlertDialogFooter, AlertDialogCancel, AlertDialogAction } from '@workspace/portfolio-os-design-system/components/ui/alert-dialog';
...
```tsx
import { Sheet, SheetTrigger, SheetContent, SheetHeader, SheetTitle } from '@workspace/portfolio-os-design-system/components/ui/sheet';
...
```tsx
import { Drawer, DrawerTrigger, DrawerContent, DrawerHeader, DrawerTitle } from '@workspace/portfolio-os-design-system/components/ui/drawer';
...
```tsx
import { Popover, PopoverTrigger, PopoverContent } from '@workspace/portfolio-os-design-system/components/ui/popover';
...
```tsx
import { HoverCard, HoverCardTrigger, HoverCardContent } from '@workspace/portfolio-os-design-system/components/ui/hover-card';
...
```tsx
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from '@workspace/portfolio-os-design-system/components/ui/tooltip';
...
```tsx
import { Command, CommandInput, CommandList, CommandGroup, CommandItem, CommandEmpty } from '@workspace/portfolio-os-design-system/components/ui/command';
